...
**Python Backend Developer & GenAI Engineer | LLMs | RAG | Django | FastAPI | REST APIs | 3+ Years Experience | Immediate Joiner | 📍 Salem, Tamil Nadu**
...
--- 
  ...
  [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/shalini-r-649114320)   [![Naukri](https://img.shields.io/badge/Naukri-FF7555?style=for-the-badge&logo=naukri&logoColor=white)](https://www.naukri.com/mnjuser/profile)   [![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:pavirathinavel@gmail.com)
...
- 🤖 **Agentic AI workflows** using **LangGraph** for automated reasoning and decision support
- 📊 **Graph Neural Networks (Graphormer)** — modeling dependency networks for risk prediction

### Recent Work
- Contributed to an **AI-powered enterprise compliance platform** (Graph RAG architecture for regulatory gap analysis)
- Built a **graph-based supply chain risk analyzer** with a FastAPI backend and interactive React dashboard
- Built **REST API systems** for document verification and employee onboarding workflows, with JWT authentication and role-based access control
...
**Core Areas:** REST APIs · Django REST Framework · Retrieval-Augmented Generation (RAG) · LLMs · Graph RAG · Hybrid RAG · Agentic AI (LangGraph) · Docker · Redis & Caching · JWT Auth & RBAC
